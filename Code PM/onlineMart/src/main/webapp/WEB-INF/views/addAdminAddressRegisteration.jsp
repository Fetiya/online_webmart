<%-- 
    Document   : addAdminAddressRegisteration
    Created on : Jan 7, 2015, 9:25:01 AM
    Author     : Komal
--%>
        ...
        <div class="row">  	
            <div class="col-sm-form">
                <div class="contact-form">
                    <form:form commandName="adminAddress" action="addAdminAddress" method="POST" enctype="multipart/form-data">
                        <table>

                            <p class="title ">Please provide your Personal address information</p>
